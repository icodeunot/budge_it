# Generated by Django 4.2.14 on 2024-10-23 05:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expenses', to='tracker.project')),
            ],
            options={
                'ordering': ('-amount',),
            },
